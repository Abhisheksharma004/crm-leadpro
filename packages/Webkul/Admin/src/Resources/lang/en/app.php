...
return [
    ...
    'help' => [
        'index' => [
            ...
            'description' => 'Everything you need to get the most out of LeadPro Admin — hosting, support and professional services, plus extensions and documentation.',
            'contact-us' => 'Contact us',
            'view-all' => 'View all',
            'still-need-help-title' => 'Still need a hand?',
            'still-need-help-description' => 'Talk to the Viros team about hosting, custom development or anything else.',

            'services' => [
                'title' => 'Services & Resources',
                'cloud-hosting' => [
                    'title' => 'Cloud Hosting',
                    'description' => 'Cost-effective, managed cloud hosting — try and launch LeadPro on the cloud in minutes, fully optimised and scalable.',
                ],
                'support' => [
                ...
                'extensions' => [
                    'title' => 'Extensions',
                    'description' => 'Browse official and community add-ons to extend LeadPro with new connectors, channels and features.',
                ],
            ],
            ...
            'resources' => [
                ...
                'api-docs' => [
                    'title' => 'API Docs',
                    'description' => 'Full REST API reference with endpoints, authentication and examples to integrate LeadPro with your stack.',
                ],
            ],
            ...
            'community' => [
                'forums' => [
                    ...
                    'description' => 'Connect with thousands of other LeadPro users and developers to share tips and solve problems.',
